...
@property (strong,nonatomic) NSString * status; // whether the message has been read or not

@property (strong,nonatomic) NSString * key; // the original key in firebase associated with this message
